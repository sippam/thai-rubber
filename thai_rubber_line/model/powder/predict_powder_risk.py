...
with open('model/powder/powder_adaptive_disease_model_with_drift.pkl', 'rb') as f:
...
def predict_powder_risk(data: InputDataRisk):
    ...
    if learn_counter >= 100:
        with open('model/powder/powder_adaptive_disease_model_with_drift.pkl', 'wb') as f:
