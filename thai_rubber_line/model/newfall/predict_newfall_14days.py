...
with open('model/newfall/newfall_adaptive_14_model_with_drift.pkl', 'rb') as f:
...
def predict_newfall_14days(data: InputDataForecast):
    ...
    if learn_counter >= 100:
        with open('model/newfall/newfall_adaptive_14_model_with_drift.pkl', 'wb') as f:
